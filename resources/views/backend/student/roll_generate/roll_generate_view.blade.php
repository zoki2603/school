...
<div class="col-md-12">
    <div class="box bb-3 border-warning">
        <div class="box-header">
            <h4 class="box-title">Roll <strong>Generate</strong></h4>
            </div>
...
{{-- ////////////////////// Role Generate Table /////////////////// --}}
                    ...
                    <input type="submit" class="btn btn-rounded btn-info" value="Role Generate">
                </form>
            </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).on('click','#search',function(){
        ...
        success: function (data) {
            ...
            '<td><input type="number" class="form-control form-control-sm" name="roll[]" value="'+v.roll+'"></td>'+
                '</tr>';
            });
