            ...
            <form  method="POST" action="{{ route('assign.subject.update',$editData[0]->class_id) }}">
                        ...
                        <div class="controls">
                            <select name="class_id" required="" class="form-control" >
                                ...
                                @foreach ($classes as $class)
                                    ...
                                    {{ ($editData['0']->class_id == $class->id)?"selected":"" }}>{{ $class->name }}</option>
                                 @endforeach
                ...
                <div class="delete_whole_extra_item" id="delete_whole_extra_item">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <h5>Student Subjct<span class="text-danger">*</span></h5>
                                <div class="controls">
                                    <select name="subject_id[]" required="" class="form-control" >
                                        <option value="" selected disabled>Select Student Subjct</option>
