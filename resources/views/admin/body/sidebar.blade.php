 @php
   $prefix = Request::route()->getPrefix(); // Izvalaci prefiks rute
   $route = Route::current()->getName();// izvlaci ime rute koje si zadao
 @endphp
 {{-- @dd($prefix) --}}
 <aside class="main-sidebar">
    ...
    @endif
        ...
        <li class="treeview {{ ($prefix == '/setups') ? 'active' : '' }}">
          <a href="#">
            <i data-feather="message-circle"></i>
            <span>Setup Menagment</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ route('student.class.view') }}"><i class="ti-more"></i>Student Clas</a></li>
        ...
        <li class="treeview {{ ($prefix == '/students') ? 'active' : '' }}">
          <a href="#">
            <i data-feather="message-circle"></i>
            <span>Student Menagment</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ route('student.registration.view') }}"><i class="ti-more"></i>Student Registaration</a></li>
            <li><a href="{{ route('role.generate.view') }}"><i class="ti-more"></i>Role Generate</a></li>
            <li><a href="{{ route('registration.fee.view') }}"><i class="ti-more"></i>Registraton Fee</a></li>
